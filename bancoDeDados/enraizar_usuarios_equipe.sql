...
CREATE TABLE `usuarios_equipe` (
  ...
  `id` int NOT NULL,
  PRIMARY KEY (`id_usuario`,`id_equipe`,`id`),
  KEY `id_equipe` (`id_equipe`),
  CONSTRAINT `usuarios_equipe_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `usuarios_equipe_ibfk_2` FOREIGN KEY (`id_equipe`) REFERENCES `equipes` (`id`) ON DELETE CASCADE
...
INSERT INTO `usuarios_equipe` VALUES (1,1,'Membro',0),(2,1,'PO',0);
...
-- Dump completed on 2025-08-23 16:16:59
